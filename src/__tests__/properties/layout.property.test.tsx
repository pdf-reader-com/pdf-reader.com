...
vi.mock('next-intl', () => ({
  useTranslations: () => (key: string) => {
    const translations: Record<string, string> = {
      'brand': 'PDFReader',
      'tagline': 'Professional online PDF tools and Android reader - Free & Private',
      ...
      'buttons.close': 'Close',
      'footer.copyright': '© {year} PDFReader. All rights reserved.',
...
describe('Layout Property Tests', () => {
   ...
   * SHALL contain the brand name "PDFReader" in the header or title area.
   */
  describe('Property 2: Brand Consistency', () => {
    it('Header component displays PDFReader brand name for all locales', () => {
      fc.assert(
        fc.property(
          ...
          (locale) => {
            ...
            expect(brandElement.textContent).toBe('PDFReader');
    ...
    it('Footer component displays PDFReader brand name for all locales', () => {
      fc.assert(
        fc.property(
          fc.constantFrom(...locales),
          (locale) => {
      ...
      fc.assert(
        fc.property(
          ...
          (locale) => {
            ...
            expect(headerBrandText).toBe('PDFReader');
